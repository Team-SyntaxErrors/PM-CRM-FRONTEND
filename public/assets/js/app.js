document.addEventListener('DOMContentLoaded', function (e) {
	!(function () {
		...
		window.sessionStorage &&
			...
			(function () {
				...
				window.onload = function () {
					1024 <= window.innerWidth &&
						...
						(document.body.setAttribute('data-sidebar-size', 'sm'), i('sidebar-size-small'));
				};
				setTimeout(() => {
					for (var t = document.getElementsByClassName('vertical-menu-btn'), a = 0; a < 2; a++)
						if (t[a]) {
			...
			// }),
			(e = document.getElementsByTagName('body')[0]).hasAttribute('data-layout') &&
				...
				t.addEventListener('change', function (t) {
					t &&
						...
						(window.location.href =
							'vertical' == t.target.value ? 'index.html' : 'layouts-horizontal.html');
				});
			});
	})();
});
